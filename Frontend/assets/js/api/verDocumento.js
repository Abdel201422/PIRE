...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Cargar toda la información del documento en una sola llamada
    cargarDocumento(documentoContainer, downloadDocument)
...
// Función principal que carga toda la información del documento
function cargarDocumento(documentoContainer, downloadDocument) {
    ...
    .then(data => {
        ...
        // Llenar la información del documento
