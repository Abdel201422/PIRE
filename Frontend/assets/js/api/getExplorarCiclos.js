...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch(`${BACKEND_URL}/api/ciclos/completos`, {
        ...
        .then(data => {
            ...
            btnTodos.className = 'flex-none tab-button border-b-2 border-pire-green pl-4 pr-4 font-semibold whitespace-nowrap'
            ...
            data.forEach(ciclos => {
                ...
                btnCiclo.className = 'flex-none tab-button pl-4 pr-4 whitespace-nowrap'
